    ...
    children: [
      {
        ...
        align: "center",
        children: [
          { type: "text", text: "{{current_pressure}}", style: { base: "dataText", font:"monospace", fontSize: 35, bold: true, color: "{{current_pressureColor}}", lineLimit: 1, minimumScaleFactor: 0.9 } }
        ]
      },
      { type: "spacer" },
      {
